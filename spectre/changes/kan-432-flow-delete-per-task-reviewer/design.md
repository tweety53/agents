# kan-432-flow-delete-per-task-reviewer — design

Approved design, staged as `docs/superpowers/specs/2026-09-05-kan-432-flow-delete-per-task-reviewer-design.md`; this file is canonical from here on.
