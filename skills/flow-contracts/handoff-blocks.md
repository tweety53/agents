...
**Change:** <name>
**Panel:** (run-only) <the required slots, and the optional ones selected or "none — no triggers fired"> · <default|dynamic — class, compact?, rerun policy, dispatches: <group> · <group>, rerun: <model>/low>
