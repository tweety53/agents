...
*The heading keeps its former name deliberately.* **Rendering the session records**
(`skills/myflow-contracts/pipeline.md`) cites this section inline by it, and `check-references.sh`
