...
must satisfy. Implementer dispatches in `/myflow-do`, `/myflow-do-fix`, and
`/myflow-fast-path` require this file as reading; the panel's principles reviewer checks
