...
- **[flow-improvement]** the targeted round-1 re-runs caught the two defects the fix diff itself introduced; duplicate of KAN-522 from the kan-512 pass — declined
