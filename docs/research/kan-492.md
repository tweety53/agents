...
`docs/research/<name-or-key>.md` seed lookup, `flow stage` marks `flow.kickoff`,
...
Plan: `docs/research/kan-492/tasks.md` (`check-plan-shape.sh` clean).
Decision: `docs/research/kan-492/decision.json`.
