...
(section 2) — plus one follow-up round on an item the first thread had left open (section 3). The earlier note `docs/research/flow-speedup.md` (2026-09-04) covers the
