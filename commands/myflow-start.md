...
id: myflow-start
category: myflow
description: Start — brainstorm, write the spectre artifacts, publish the proposal artifact
---
...
Runs Superpowers **#1** (brainstorming, with its design approval gate) and **#3** (writing-plans), woven into the spectre artifacts, then publishes the proposal artifact the human reads.
