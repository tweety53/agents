...
**Model:** Opus (or your default) is fine here — no brainstorming or implementation happens in this command. In Cursor this is a recommendation rather than an enforced switch: switch models in the composer's picker.
