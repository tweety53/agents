...
# to a declared expected-zero member (skills/spectre-research/SKILL.md):
...
printf 'Follow **Panel re-runs** in `../spectre-research/SKILL.md`.\n' \
  > "$FIXTURE/skills/demo/SKILL.md"
run_guard "$FIXTURE"
...
# declared expected-zero member (skills/spectre-research/SKILL.md), as case
...
new_fixture
mkdir -p "$FIXTURE/skills/spectre-research" "$FIXTURE/.myflow"
